...
export function QuotationSentEmail({
	...
	return (
		<Html>
			<Head />
			<Preview>Your quotation is ready — {currency} {price}</Preview>
			<Body style={body}>
				<Container style={container}>
					...
					<Text style={text}>
						We have prepared a quotation for your trip request. Please review
						it and let us know if you'd like to accept or decline.
					</Text>
					...
					<Section style={priceBox}>
						...
						{isPriceEachWay && (
							<Text style={priceMeta}>Price applies to each direction separately</Text>
						)}
						{areCarSeatsIncluded && (
...
const priceLabel = { color: "#166534", fontSize: "13px", margin: "0 0 8px", fontWeight: "600" };
const priceValue = { color: "#14532d", fontSize: "36px", fontWeight: "700", margin: "0 0 8px" };
const priceMeta = { color: "#166534", fontSize: "13px", margin: "4px 0 0" };
const sectionTitle = { color: "#1a1a1a", fontSize: "15px", fontWeight: "600", margin: "0 0 8px" };
const infoText = {
	color: "#4a4a4a",
	fontSize: "14px",
	lineHeight: "22px",
